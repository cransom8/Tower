...
public static class SetupTTRTSSkins
{
    ...
    static readonly Entry[] Entries =
    {
        ...
        new Entry { skinKey = "tt_paladin", unitType = "tt_paladin", prefabName = "TT_Paladin", sampleController = "sample_shield", scale = HeroPresentationTweaks.HeroScale },
        new Entry { skinKey = "tt_commander", unitType = "tt_commander", prefabName = "TT_Commander", sampleController = "sample_infantry", scale = HeroPresentationTweaks.HeroScale },
        new Entry { skinKey = "tt_king", unitType = "tt_king", prefabName = "TT_King", sampleController = "sample_two_handed", scale = HeroPresentationTweaks.HeroScale },
