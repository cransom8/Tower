            ...
            return new RaceProgressionDefinition(
                ...
                new RaceProgressionLaneDefinition(
                    ...
                    RequirementStepCard(
                        ...
                        "Market",
                        marketT1,
                        "Market Tier 1 gate for the economy line. Building it unlocks Peasant purchases and starts the rear-gate trade route.",
                        nextUnitId: "peasant"),
                    new RaceProgressionUnitDefinition(
                        "peasant",
                        marketLane,
                        ...
                        description: "Market Tier 1 economy unit. Runs goods from the Market through the Rear Gate to the Beast Lair for 4 gold each completed lap.",
                        nextUnitId: "settler",
                        statsSummary: "4 gold/lap   Market -> Rear Gate -> Beast Lair   Economy unit",
                    ...
                    new RaceProgressionUnitDefinition(
                        ...
                        description: "Market Tier 2 economy unit. Replaces Peasants on the Market route and earns 7 gold each completed lap.",
                        nextUnitId: "trader",
                        statsSummary: "7 gold/lap   Market -> Rear Gate -> Beast Lair   Auto-upgrades workers",
                        cardTag: "Economy Unit"),
                    new RaceProgressionUnitDefinition(
                        "trader",
                        marketLane,
                        ...
                        description: "Market Tier 3 economy unit. Replaces Settlers on the Market route and carries the highest-value cargo for 10 gold each completed lap.",
                        statsSummary: "10 gold/lap   Market -> Rear Gate -> Beast Lair   Top-tier trade unit",
                        cardTag: "Economy Unit")
                ),
                new RaceProgressionLaneDefinition(
                    stableHorseLane,
