...
const AI_ACTION_TYPE = Object.freeze({
  ...
  BUILD_PAD: "BUILD_PAD",
  UPGRADE_PAD: "UPGRADE_PAD",
  BUILD_BARRACKS_SITE: "BUILD_BARRACKS_SITE",
  UPGRADE_BARRACKS_SITE: "UPGRADE_BARRACKS_SITE",
  BUY_BARRACKS_UNIT: "BUY_BARRACKS_UNIT",
  BUY_MARKET_UNIT: "BUY_MARKET_UNIT",
  DEPLOY_BARRACKS_HERO: "DEPLOY_BARRACKS_HERO",
  SET_LANE_COMMAND: "SET_LANE_COMMAND",
});
