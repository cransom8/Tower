...
const battlefieldLayoutSystem = require("./game/multilane/battlefieldLayoutSystem");
...
function createMLPublicConfig(options, deps) {
  ...
  const battlefieldLayout = battlefieldLayoutSystem.buildBattlefieldLayout(opt, {
    FORTRESS_PAD_DEFS,
    BARRACKS_SITE_DEFS,
    ROUTE_SEGMENT_POLYLINES,
    getLaneNodeId,
