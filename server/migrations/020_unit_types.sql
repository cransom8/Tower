...
INSERT INTO unit_types (
  ...
  ('runner',
   ...
   60,   5.0, 1.0, 0.0,  0.055, 'NORMAL',   'UNARMORED',  0,  1,  0, 0, 70, TRUE,  FALSE),
  ('footman',
   'Footman',  'Balanced infantry attacker.',
   90,   7.0, 1.0, 0.0,  0.040, 'NORMAL',   'LIGHT',      0,  2,  0, 0, 70, TRUE,  FALSE),
  ('ironclad',
   'Ironclad', 'Heavy armoured attacker. Slow but durable.',
   160, 10.0, 0.8, 0.0,  0.025, 'NORMAL',   'HEAVY',     20,  4,  0, 0, 70, TRUE,  FALSE),
  ('warlock',
   'Warlock',  'Magic attacker. Bypasses physical armour.',
   80, 12.0, 1.0, 0.0,  0.035, 'MAGIC',    'LIGHT',      0,  5,  0, 0, 70, TRUE,  TRUE),
  ('golem',
   'Golem',    'Boss-tier attacker. Extremely high HP and damage.',
   240, 18.0, 0.7, 0.0,  0.020, 'PHYSICAL', 'HEAVY',     30, 10,  0, 0, 70, TRUE,  FALSE),
  ('archer',
   'Archer',   'Fast ranged defender. Effective against light armour.',
   50,  6.6, 1.0, 0.36, 0.0,  'PIERCE',   'UNARMORED',  0,  0, 10, 1, 70, FALSE, FALSE),
  ('fighter',
   'Fighter',  'Close-range melee defender. High single-target damage.',
   80,  8.8, 1.0, 0.22, 0.0,  'NORMAL',   'MEDIUM',     0,  0, 12, 1, 70, FALSE, FALSE),
  ('mage',
   'Mage',     'Magic damage defender. Bypasses physical armour.',
   60, 13.2, 1.0, 0.35, 0.0,  'MAGIC',    'LIGHT',      0,  0, 24, 1, 70, FALSE, TRUE),
  ('ballista',
   'Ballista', 'Long-range siege defender. Excels against heavy units.',
   70, 12.1, 1.0, 0.40, 0.0,  'SIEGE',    'MEDIUM',     0,  0, 20, 1, 70, FALSE, FALSE),
  ('cannon',
   'Cannon',   'Slow but devastating area-of-effect defender.',
   90,  8.0, 0.8, 0.32, 0.0,  'SPLASH',   'MEDIUM',     0,  0, 30, 1, 70, FALSE, FALSE),
  ('wall_placeholder',
   'Wall',     'Placeholder tile. Place to later upgrade to a fixed defender.',
   200,  0.0, 0.0, 0.0,  0.0,  'NORMAL',   'HEAVY',     40,  0,  2, 0, 100, FALSE, FALSE)
