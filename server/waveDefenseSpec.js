...
const LOCKED_WAVE_PLAN = Object.freeze([
  ...
  { wave_number: 4,  unit_type: "fantasy_wolf",    spawn_qty: 13, hp_mult: 1.15, dmg_mult: 1.10, speed_mult: 1.05, is_boss: false, note: "early spike" },
  { wave_number: 5,  unit_type: "wyvern",          spawn_qty: 5,  hp_mult: 1.85, dmg_mult: 1.70, speed_mult: 1.02, is_boss: true,  note: "locked boss" },
  ...
  { wave_number: 8,  unit_type: "lizard_warrior",  spawn_qty: 14, hp_mult: 1.35, dmg_mult: 1.26, speed_mult: 1.04, is_boss: false, note: "agile melee" },
  { wave_number: 9,  unit_type: "darkness_spider", spawn_qty: 14, hp_mult: 1.42, dmg_mult: 1.32, speed_mult: 1.05, is_boss: false, note: "ranged venom pressure" },
  { wave_number: 10, unit_type: "demon_lord",      spawn_qty: 4,  hp_mult: 2.00, dmg_mult: 1.90, speed_mult: 1.02, is_boss: true,  note: "locked boss" },
  { wave_number: 11, unit_type: "giant_viper",     spawn_qty: 14, hp_mult: 1.70, dmg_mult: 1.50, speed_mult: 1.08, is_boss: false, note: "pierce threat" },
  { wave_number: 12, unit_type: "undead_warrior",  spawn_qty: 14, hp_mult: 1.75, dmg_mult: 1.50, speed_mult: 1.02, is_boss: false, note: "slow wall" },
  { wave_number: 13, unit_type: "orc",             spawn_qty: 14, hp_mult: 1.85, dmg_mult: 1.58, speed_mult: 1.02, is_boss: false, note: "midgame bruiser" },
  { wave_number: 14, unit_type: "skeleton_knight", spawn_qty: 13, hp_mult: 1.95, dmg_mult: 1.68, speed_mult: 1.03, is_boss: false, note: "heavy armor check" },
  { wave_number: 15, unit_type: "oak_tree_ent",    spawn_qty: 6,  hp_mult: 2.25, dmg_mult: 1.90, speed_mult: 0.98, is_boss: true,  note: "team pick boss: giant tank" },
  { wave_number: 16, unit_type: "harpy",           spawn_qty: 15, hp_mult: 2.10, dmg_mult: 1.75, speed_mult: 1.14, is_boss: false, note: "fast ranged harass" },
  { wave_number: 17, unit_type: "troll",           spawn_qty: 11, hp_mult: 2.15, dmg_mult: 1.75, speed_mult: 1.02, is_boss: false, note: "regen bruiser" },
  { wave_number: 18, unit_type: "mummy",           spawn_qty: 12, hp_mult: 2.35, dmg_mult: 1.95, speed_mult: 1.00, is_boss: false, note: "durability ramp" },
  { wave_number: 19, unit_type: "dragonide",       spawn_qty: 12, hp_mult: 2.55, dmg_mult: 2.05, speed_mult: 1.02, is_boss: false, note: "elite reptilian" },
  { wave_number: 20, unit_type: "chimera",         spawn_qty: 6,  hp_mult: 2.90, dmg_mult: 2.35, speed_mult: 1.02, is_boss: true,  note: "team pick boss: magical beast" },
  { wave_number: 21, unit_type: "werewolf",        spawn_qty: 11, hp_mult: 2.60, dmg_mult: 2.15, speed_mult: 1.12, is_boss: false, note: "feral speed check" },
  { wave_number: 22, unit_type: "ogre",            spawn_qty: 11, hp_mult: 2.75, dmg_mult: 2.25, speed_mult: 1.00, is_boss: false, note: "slow heavy hits" },
  { wave_number: 23, unit_type: "vampire",         spawn_qty: 13, hp_mult: 2.95, dmg_mult: 2.40, speed_mult: 1.05, is_boss: false, note: "life drain elite" },
  { wave_number: 24, unit_type: "evil_watcher",    spawn_qty: 14, hp_mult: 3.20, dmg_mult: 2.60, speed_mult: 1.05, is_boss: false, note: "magic artillery" },
  { wave_number: 25, unit_type: "mountain_dragon", spawn_qty: 6,  hp_mult: 3.80, dmg_mult: 3.30, speed_mult: 1.02, is_boss: true,  note: "locked boss" },
  { wave_number: 26, unit_type: "griffin",         spawn_qty: 10, hp_mult: 3.35, dmg_mult: 2.70, speed_mult: 1.08, is_boss: false, note: "post-boss elite flier" },
  { wave_number: 27, unit_type: "cyclops",         spawn_qty: 10, hp_mult: 3.50, dmg_mult: 2.90, speed_mult: 1.00, is_boss: false, note: "siege bruiser" },
  { wave_number: 28, unit_type: "manticora",       spawn_qty: 9,  hp_mult: 3.65, dmg_mult: 3.05, speed_mult: 1.02, is_boss: false, note: "ranged monster" },
  { wave_number: 29, unit_type: "ice_golem",       spawn_qty: 10, hp_mult: 3.95, dmg_mult: 3.25, speed_mult: 1.00, is_boss: false, note: "final tank check" },
  { wave_number: 30, unit_type: "hydra",           spawn_qty: 6,  hp_mult: 5.10, dmg_mult: 4.60, speed_mult: 1.02, is_boss: true,  note: "final spike; Dragonhide placeholder until confirmed" },
]);
...
const TT_UNIT_ROSTER = Object.freeze([
  ...
  { skin_key: "tt_priest",          name: "Priest",           unit_type: "tt_priest",          role: "Healer / Support",        expects_projectile: false },
  { skin_key: "tt_high_priest",     name: "High Priest",      unit_type: "tt_high_priest",     role: "Healer / Support",        expects_projectile: false },
  { skin_key: "tt_mage",            name: "Mage",             unit_type: "tt_mage",            role: "Ranged",                  expects_projectile: true  },
  { skin_key: "tt_paladin",         name: "Paladin",          unit_type: "tt_paladin",         role: "Frontline",               expects_projectile: false },
  { skin_key: "tt_commander",       name: "Bishop",           unit_type: "tt_commander",       role: "Healer / Support",        expects_projectile: false },
  ...
  { skin_key: "tt_mounted_priest",  name: "Mounted Priest",   unit_type: "tt_mounted_priest",  role: "Healer / Support",        expects_projectile: false },
